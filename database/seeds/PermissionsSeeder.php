...
class PermissionsSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions[] = Permission::create([
            ...
            'display_name' => 'Manage Reseller Settings',
            'description' => '',
            'removable' => false
        ]);

        $permissions[] = Permission::create([
            'name' => 'reseller.manage.branch',
            'display_name' => 'Allows Reseller to Manage Branch Offices',
            'description' => '',
            'removable' => false
        ]);
        ...
        $permissions[] = Permission::create([
            'name' => 'reseller.view',
            'display_name' => 'View Reseller Details',
            'description' => '',
            'removable' => false
        ]);
        ...
        $permissions[] = Permission::create([
            'name' => 'reseller.edit',
            'display_name' => 'Edit Reseller Details',
            'description' => '',
            'removable' => false
        ]);
        ...
        $permissions[] = Permission::create([
            ...
            'display_name' => 'Manage Customer Settings',
            'description' => '',
            'removable' => false
        ]);
