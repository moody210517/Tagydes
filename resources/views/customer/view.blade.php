...
@section('page-title', trans('app.view_customer'))
@section('page-heading', trans('app.view_customer'))
...
<ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item active">{{ $customer->company_name }}</li>
</ol>

<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">@lang('app.view_customer')</h1>
