...
@section('page-title', trans('app.edit_reseller'))
@section('page-heading', trans('app.edit_reseller'))
...
<ol class="breadcrumb pull-right">
    ...
    <li class="breadcrumb-item"><a href="{{ route('reseller.show', $reseller->id) }}">{{ $reseller->company_name }}</a></li>
    <li class="breadcrumb-item active">{{ trans('app.edit_reseller') }}</li>
</ol>

<!-- end breadcrumb -->
<!-- begin page-header -->
<h1 class="page-header">@lang('app.edit_reseller')</h1>
