...
{!! Form::open(['route' => 'news.update', 'files' => true, 'id' => 'customer-form']) !!}
    <div class="card">
        <div class="card-body">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-6">                
                    <div class="form-group">
                        ...
                        name="title" placeholder="Title" value="{{$news->title}}">
                    </div>

                    <div class="form-group">
                        <label for="postal_code"> Description </label>
                        <textarea type="text" class="form-control" name="description" placeholder="@lang('app.postal_code')" value=""> {{$news->description}} </textarea>
                    </div>

                    <div class="form-group">
                        <label for="postal_code">Video (Youtube link) </label>
                        <input type="text" class="form-control" id="postal_code"
                        name="video" placeholder="Video link" value="{{$news->video}}">
                    </div>
