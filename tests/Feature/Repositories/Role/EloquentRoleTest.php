...
class EloquentRoleTest extends FunctionalTestCase
{
    ...
    {
        $this->expectsEvents(\Tagydes\Events\Role\Updated::class);
    ...
    {
        $this->expectsEvents(\Tagydes\Events\Role\Deleted::class);
    ...
    {
        $role = factory(Role::class)->create();
        $permissions = factory(\Tagydes\Permission::class)->times(2)->create();
