...
// Route::domain('tenancy.app')->group(function () {
//     Route::get('/', 'HomeController');
// });

/**
* Add middleware with roles and permission
*/
 ...
 * Authentication
 */
Route::post('udpateUserBranch', 'ApiController@udpateUserBranch');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    * Resellers
    */
    Route::group(['middleware' => 'permission:reseller.manage'], function () {
        
        Route::resource('reseller', 'ResellersController'); // ->except(['show'])
        Route::get('reseller', [
            'as' => 'reseller.list',
            'uses' => 'ResellersController@index'
        ]);

        Route::put('reseller/{reseller}/update/details', [
            'as' => 'reseller.update.details',
            'uses' => 'ResellersController@update'
        ]);

        Route::delete('reseller/{reseller}/delete', [
            'as' => 'reseller.delete',
            'uses' => 'ResellersController@delete'
        ]);

        Route::get('reseller/{reseller}/status', [
            'as' => 'reseller.status',
            'uses' => 'ResellersController@status'
        ]);

        Route::get('reseller/{reseller}/branch', [
            'as' => 'reseller.branch',
            'uses' => 'ResellersController@index'
        ]);        
        Route::get('reseller/{reseller}/user', [
            'as' => 'reseller.user',
            'uses' => 'UsersController@resellerUsers'
        ]);
        Route::get('reseller/{reseller}/customer', [
            'as' => 'reseller.customer',
            'uses' => 'CustomersController@resellerCustomer'
        ]);
    });
    
    Route::group(['middleware' => 'permission:reseller.view'], function () {
    ...
    Route::group(['middleware' => 'permission:reseller.manage.branch'], function () {
       ...
       Route::resource('branch', 'BranchController');
        ...
        Route::get('branch/{branch}/delete', [
            'as' => 'branch.delete',
            'uses' => 'BranchController@delete'
        ]);

        Route::post('branch/update', [
            'as' => 'branch.updateBranch',
    ...
    Route::get('boffice', [
        'as' => 'branch_office.list',
        'uses' => 'ResellersController@branchlist'
    ]);
    ...
    */
    Route::group(['middleware' => 'permission:customer.manage'], function () {
        ...
        Route::get('customer/{customer}/delete', [
            'as' => 'customer.delete',
            'uses' => 'CustomersController@delete'
        ]);
        Route::get('customer/{customer}/user', [
            'as' => 'customer.user',
            'uses' => 'UsersController@customerUsers'
        ]);

        Route::put('customer/{customer}/update/details', [
            'as' => 'customer.update.details',
